import { faEdit, faEllipsisVertical, faEye, faFilePdf, faRemove, faSave, faSuitcase, faTrash, faPlus, } from '@fortawesome/free-solid-svg-icons'
...
import { EmployeeProfileUpdate, JobUserView, ListPersonalEducation, ListPersonalSkills, ListRequiredSkills, List_Skills, UserProfileDetails } from '../../../Constants/Constants'
        ...
        <div className='flex justify-center'>
            ...
            <Dialog
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className=' shadow-2xl border-[1px] text-center font-prompt ml-6 w-[90%]   text-black text-lg border-[#000000] top-80 rounded-sm'>
                        <div className='flex flex-row justify-between mt-1 ml-4'>
                            ...
                            <div>
                                <FontAwesomeIcon onClick={removeCV} icon={faTrash} color='#051339' className='mr-2 hover:text-[#403f3f] bg-white border-4 border-white  hover:cursor-pointer' />
                                <FontAwesomeIcon onClick={HandleCV} icon={faEdit} color='#051339' className='hover:text-[#403f3f] bg-white border-4 border-white  hover:cursor-pointer' />
                            </div>
                            {/* <Menu>
                                <MenuHandler>
                ...
                <DialogFooter>
                    ...
                    <Button variant="filled" className='bg-[#051339] font-prompt-normal'>
                        <span>Apply </span>
                    </Button>
                </DialogFooter>
                <Toaster />
